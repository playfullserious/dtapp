      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          <div className="inline-block mb-6">
            <div className="w-24 h-24 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl flex items-center justify-center shadow-2xl transform hover:scale-105 transition-transform">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            <br />
            Enhance your B-School journey with interactive materials.
          </p>
              ...
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div className="text-left">
                  ...
                  <span className="inline-block mt-1 px-3 py-1 text-xs font-medium rounded-full bg-indigo-100 text-indigo-700">
                    {(session.user as any).role === 'faculty' ? '👨‍🏫 Faculty' : '🎓 Student'}
                  </span>
                </div>
              </div>
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8">
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">Access high-quality learning materials curated by your faculty</p>
          </div>
